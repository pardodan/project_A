...
np.save("indices_index_small_resnet18.npy", indices, allow_pickle=True, fix_imports=True)
np.save("distances_index_small_resnet18.npy", distances, allow_pickle=True, fix_imports=True)
np.save("cosine_mat_index_small_resnet18.npy", cosine_dist, allow_pickle=True, fix_imports=True)
